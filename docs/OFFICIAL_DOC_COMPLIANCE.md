...
Development uses the supplied `sing-box-official-docs-cn-2026-08-27.zip`. Its complete `sing-box-official-docs-cn/` extraction contains 89 files; all 88 files listed by `MANIFEST.md` pass SHA-256 verification. The primary tested runtime baseline is `1.14.0-rc.1`; 1.13-compatible output remains covered by the compatibility suite.
