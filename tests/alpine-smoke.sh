...
export SBM_PREFIX="$ROOT/download/usr/local" SBM_LIB="$PROJECT" SBM_BIN_DIR="$ROOT/download/usr/local/bin"
export SBM_ETC="$ROOT/download/etc/sb-manager" SBM_VAR="$ROOT/download/var/lib/sb-manager" SBM_RUN="$ROOT/download/run/sb-manager"
...
export SBM_CORE_DIR="$ROOT/download/cores" SBM_LOCK="$SBM_RUN/manager.lock"
...
export SBM_PREFIX="$ROOT/install/usr/local" SBM_LIB="$ROOT/install/usr/local/lib/sb-manager" SBM_BIN_DIR="$ROOT/install/usr/local/bin"
export SBM_ETC="$ROOT/install/etc/sb-manager" SBM_VAR="$ROOT/install/var/lib/sb-manager" SBM_RUN="$ROOT/install/run/sb-manager"
export SBM_SYSTEMD_DIR="$ROOT/install/etc/systemd/system" SBM_OPENRC_DIR="$ROOT/install/etc/init.d" SBM_PERIODIC_DIR="$ROOT/install/etc/periodic" SBM_LOG_DIR="$ROOT/install/var/log/sb-manager"
export SBM_STATE="$SBM_ETC/state.json" SBM_GENERATED_DIR="$SBM_ETC/generated" SBM_CONFIG="$SBM_GENERATED_DIR/config.json"
export SBM_SECRETS="$SBM_ETC/secrets" SBM_CERTS="$SBM_ETC/certs" SBM_BACKUPS="$SBM_VAR/backups" SBM_EXPORTS="$SBM_VAR/exports" SBM_CACHE="$SBM_VAR/cache"
export SBM_CORE_DIR="$SBM_LIB/cores" SBM_LOCK="$SBM_RUN/manager.lock" SBM_SING_BOX_BIN="$SBM_BIN_DIR/sing-box" SBM_CLOUDFLARED_BIN="$SBM_BIN_DIR/cloudflared"
export SBM_SERVICE_USER=root SBM_FAKE_RC_LOG="$ROOT/rc.log" SBM_FAKE_RC_STATE="$ROOT/rc-state"
